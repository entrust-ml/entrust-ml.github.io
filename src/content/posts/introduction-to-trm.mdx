...
At the time of writing this post, TRM sits at a decent place on the official ARC-AGI-2 leaderboard, reaching 6.3% accuracy at &#0036;2.10 per task. Keep in mind that unlike its big labs' competitors, TRM is trained *from scratch* and will limited compute budget (roughly 10h of 8 H100s).
