      ...
      <section className="mb-16">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-apple-gray-700 mb-2">Real-world Impact</h3>
            <p className="text-sm text-apple-gray-500">
              Work on problems related to real-world applications.
              Our product is used by millions of people worldwide to verify their identity.
            </p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-semibold text-apple-gray-700 mb-2">Relevant problems</h3>
            <p className="text-sm text-apple-gray-500">
              Work on deepfake detection, bias mitigation, document understanding and other problems that are important to our customers and society.
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-sm text-apple-gray-500">
              We work with cutting-edge ML tooling and infrastructure, and have a culture of learning and growth.
            </p>
          </div>
        </div>
      </section>
